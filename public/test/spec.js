        ...
        $([
            '<form id="containerForm" class="form-horizontal">',
                '<div class="form-group">',
                    ...
                    '</div>',
                    '<div class="col-lg-4">',
                        '<input type="text" class="form-control" name="body" required placeholder="body" data-bv-notempty-message="The body is required" />',
                    '</div>',
                '</div>',
                '<div id="errors"></div>',
            '</form>'
...
describe('container field option', function() {
    ...
    it('field container declarative', function() {
        ...
        expect($.trim($('.bodyMessage').text())).toEqual('The body is required');
    });
...
describe('group option', function() {
            ...
            '<form id="groupForm" method="post" class="form-horizontal">',
                '<div class="form-group">',
                    ...
                    '<div class="bodyGroup">',
                        ...
                        '<div class="col-sm-4">',
                            '<input type="text" class="form-control" name="body" data-bv-group=".bodyGroup" />',
                        '</div>',
                    '</div>',
                '</div>',
    ...
    it('group declarative', function() {
        ...
        this.$body.val('Last');
        this.bv.validate();
        expect(this.$body.parents('.bodyGroup').hasClass('has-success')).toBeTruthy();
        expect(this.$body.parents('.bodyGroup').hasClass('has-error')).toEqual(false);
        expect(this.$body.parents('.form-group').hasClass('has-success')).toEqual(false);
        expect(this.$body.parents('.form-group').hasClass('has-error')).toEqual(false);
    });
});
